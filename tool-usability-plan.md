...
Status: Linux and applicable Windows changes integrated into main for v0.5.4,
preserving newer SFTP fallback, remote identity safeguards, and dynamic proxy
discovery. The sections below retain the design and acceptance criteria.
...
GUI runtime is available here. Native Windows tests also run in release CI.
